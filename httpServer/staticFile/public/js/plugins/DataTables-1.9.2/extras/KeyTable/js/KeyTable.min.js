...
b),c,b),d++;return d}function k(a,c){if(q!=a){"undefined"==typeof c&&(c=!0);null!==q&&z(q);jQuery(a).addClass(s);jQuery(a).parent().addClass(s);var b;if(j){b=j.fnSettings();for(var d=A(a)[1],e=m;d>=b.fnDisplayEnd();)0<=b._iDisplayLength?b._iDisplayStart+b._iDisplayLength<b.fnRecordsDisplay()&&(b._iDisplayStart+=b._iDisplayLength):b._iDisplayStart=0,j.oApi._fnCalculateEnd(b);for(;d<b._iDisplayStart;)b._iDisplayStart=0<=b._iDisplayLength?b._iDisplayStart-b._iDisplayLength:0,0>b._iDisplayStart&&(b._iDisplayStart=
...
(""!==b.oScroll.sX||""!==b.oScroll.sY))g[1]-=$(b.nTable.parentNode).scrollTop(),g[0]-=$(b.nTable.parentNode).scrollLeft();g[1]+k>i+f?(f=g[1]+k-f,document.documentElement.scrollTop=f,document.body.scrollTop=f):g[1]<i&&(f=g[1],document.documentElement.scrollTop=f,document.body.scrollTop=f);g[0]+n>e+d?(d=g[0]+n-d,document.documentElement.scrollLeft=d,document.body.scrollLeft=d):g[0]<e&&(d=g[0],document.documentElement.scrollLeft=d,document.body.scrollLeft=d)}if(j&&"undefined"!=typeof b.oScroll&&(""!==
b.oScroll.sX||""!==b.oScroll.sY))(b=b.nTable.parentNode,f=b.clientHeight,d=b.clientWidth,i=b.scrollTop,e=b.scrollLeft,k=a.offsetHeight,n=a.offsetWidth,a.offsetTop+k>f+i?b.scrollTop=a.offsetTop+k-f:a.offsetTop<i&&(b.scrollTop=a.offsetTop),a.offsetLeft+n>d+e)?b.scrollLeft=a.offsetLeft+n-d:a.offsetLeft<e&&(b.scrollLeft=a.offsetLeft);m||(m=!0);v("focus",l,h)}}function w(){z(q);q=h=l=null;m=!1}function z(a){jQuery(a).removeClass(s);jQuery(a).parent().removeClass(s);v("blur",l,h)}function B(){for(var a=
...
c){D=c;"undefined"==typeof a&&(a={});"undefined"==typeof a.focus&&(a.focus=[0,0]);"undefined"==typeof a.table?a.table=jQuery("table.KeyTable")[0]:$(a.table).addClass("KeyTable");"undefined"!=typeof a.focusClass&&(s=a.focusClass);"undefined"!=typeof a.datatable&&(j=a.datatable);"undefined"==typeof a.initScroll&&(a.initScroll=!0);"undefined"==typeof a.form&&(a.form=!1);x=a.form;t=a.table.getElementsByTagName("tbody")[0];if(x){var b=document.createElement("div");n=document.createElement("input");b.style.height=
"1px";b.style.width="0px";b.style.overflow="hidden";"undefined"!=typeof a.tabIndex&&(n.tabIndex=a.tabIndex);b.appendChild(n);a.table.parentNode.insertBefore(b,a.table.nextSibling);jQuery(n).focus(function(){if(!o){m=true;o=false;typeof a.focus.nodeName!="undefined"?k(a.focus,a.initScroll):k(r(a.focus[0],a.focus[1]),a.initScroll);setTimeout(function(){n.blur()},0)}});m=!1}else"undefined"!=typeof a.focus.nodeName?k(a.focus,a.initScroll):k(r(a.focus[0],a.focus[1]),a.initScroll),m||(m=!0);jQuery.browser.mozilla||
jQuery.browser.opera?jQuery(document).bind("keypress",C):jQuery(document).bind("keydown",C);j?jQuery("tbody td",j.fnSettings().nTable).live("click",B):jQuery("td",t).live("click",B);jQuery(document).click(function(b){for(var b=b.target,c=false;b;){if(b==a.table){c=true;break}b=b.parentNode}c||w()})})(E,this)};
