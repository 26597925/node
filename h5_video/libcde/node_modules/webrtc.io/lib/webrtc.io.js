...
function attachEvents(manager) {
  ...
  manager.on('connection', function(socket) {
    ...
    socket.on('message', function(msg) {
      ...
      if( json.eventName ) rtc.fire(json.eventName, json.data, socket);
      else if( json.method ) rtc.fire("onmethod_" + json.method, json, socket);
    });
    ...
    socket.on('close', function() {
      ...
      if( rtc._peerMap && rtc._peerMap[socket._peerId] )
      {
    	  delete rtc._peerMap[socket._peerId];
      }
