...
p2p$.com.webp2p.core.common.LOG_TYPE = {
	kLogTypeNone : 0x00,
...
p2p$.com.webp2p.core.common.Log = {
	...
	trace : function(logTime, fmt) {
		...
		var logType = p2p$.com.webp2p.core.common.LOG_TYPE.kLogTypeConsole;
		...
		logType = p2p$.com.webp2p.core.common.LOG_TYPE.kLogTypeMemory;
		if ((this.logType_ & logType) == logType) {
			if (this.logPipe_) {
